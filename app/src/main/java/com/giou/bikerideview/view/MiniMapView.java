package com.giou.bikerideview.view;
...
import com.giou.bikerideview.R;
...
public class MiniMapView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mLinePaint.setStrokeWidth(3.5f);

        mBitmapIcon = BitmapFactory.decodeResource(getResources(), R.drawable.aa);
    ...
    public void loadObjFile(String fileName) {
        ...
        mObjectParser = new ObjectParser(mContext, new BuilderInterface() {
            ...
            public void addVertexGeometric(float x, float y, float z) {
                Point point = new Point((int)(x/2), (int)(y/2));
//                Point point = new Point((int)x, (int)y);
                allPoints.add(point);
                Log.d(TAG,"x="+(x/2)+"  y="+y+" count="+count++);
            }
